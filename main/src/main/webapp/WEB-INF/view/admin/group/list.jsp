                                    ...
                                    <tbody>
                                        <c:forEach var="group" items="${groups}">
                                            <tr>
                                                ...
                                                <td><span style="color: #6c757d; font-size: 0.9rem;">${empty
                                                        group.description ? 'N/A' : group.description}</span></td>
                                                <td><i class="fas fa-crown"
                                                        style="color: #ffc107; margin-right: 5px;"></i>
                                                    ${group.leaderName}</td>
                                    ...
                                    <nav aria-label="Page navigation" style="margin-top: 20px;">
                                        <ul class="custom-pagination">
                                            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                                <a class="page-link"
                                                    href="?page=${currentPage - 1}${not empty keyword ? '&keyword='.concat(keyword) : ''}"
                                                    aria-label="Previous">
                    ...
                    <div class="modal-content">
                        <form action="/admin/groups/create" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" placeholder="Mô tả mục đích nhóm..."
                                    style="min-height: 80px;"></textarea>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn-outline"
                                    onclick="closeModal('create-group-popup')">Hủy</button>
                ...
                <div id="edit-group-popup" class="modal-overlay">
                    <div class="modal-content">
                        <form action="/admin/groups/update" method="post">
                            ...
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea name="description" id="edit-group-desc" class="form-control"
                                    style="min-height: 80px;"></textarea>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn-outline"
                                    onclick="closeModal('edit-group-popup')">Hủy</button>
                ...
                <div id="delete-group-popup" class="modal-overlay">
                    <div class="modal-content" style="border-top: 5px solid #dc3545;">
                        <form action="/admin/groups/delete" method="post">
                            ...
                            <h3 style="color: #dc3545;"><i class="fas fa-exclamation-triangle"></i> Xác nhận Xóa Nhóm
                            </h3>

                            <div class="form-group">
                                <p>Bạn có chắc chắn muốn xóa vĩnh viễn nhóm <strong><span
                                            id="delete-group-name-display"></span></strong> không?</p>
                                <p
                                    style="color: #dc3545; font-size: 0.9rem; margin-top: 10px; background: #ffebee; padding: 10px; border-radius: 6px;">
                                    <i class="fas fa-info-circle"></i> Cảnh báo: Mọi dữ liệu thành viên và flashcard
                                    chia sẻ trong nhóm này sẽ bị xóa VĨNH VIỄN. Hành động này không thể hoàn tác.
                                </p>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn-outline" onclick="closeModal('delete-group-popup')">Hủy
                                    bỏ</button>
                                <button type="submit" class="btn-danger"><i class="fas fa-trash-alt"></i> Đồng ý
                                    xóa</button>
                            </div>
                        </form>
                    </div>
