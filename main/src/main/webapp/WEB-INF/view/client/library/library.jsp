    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <body>
                ...
                <div id="share-deck-popup" class="container-popup" style="display: none;">
                ...
                <script>
                    function openShareModal(deckId) {
                        document.getElementById('share-deck-id').value = deckId;
                        document.getElementById('share-deck-popup').style.display = 'flex';
                    }
                    function closeShareModal() {
                        document.getElementById('share-deck-popup').style.display = 'none';
                    }
                </script>
